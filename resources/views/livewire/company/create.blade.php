                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-3">
                            <div
                                ...
                                <div class="flex-1">
                                    <label
                                        class="block text-[11px] font-bold text-gray-900 uppercase tracking-tight mb-1">{{ (auth()->user()?->can('Manage Global System') ?? false) ? 'Organization' : 'Partner' }}
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        @if ($company_logo)
                                            <button type="button" wire:click="$set('company_logo', null)"
                                                class="text-[11px] font-bold text-red-500 hover:text-red-600">Remove</button>
                                        @endif
                                    </div>
                        ...
                        <div class="md:col-span-3">
                            ...
                            >
                                ...
                                <div class="flex flex-col items-center justify-center text-center">
                                    ...
                                    <p class="text-[11px] font-bold text-gray-900">Click or drag to upload</p>
