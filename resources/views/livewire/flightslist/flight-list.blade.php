<div class="min-h-[500px]" wire:init="$dispatch('loadFlights'); $dispatch('loadDateRailPrices')">

    {{-- Localized Backdrop Loader --}}
    <div
        wire:loading.flex
        class="absolute inset-0 z-[100] items-center justify-center bg-gray-900/40 backdrop-blur-[2px] rounded-2xl"
        aria-live="polite"
        aria-busy="true"
    >
        <div class="flex flex-col items-center justify-center gap-5 rounded-[32px] bg-white px-8 py-12 shadow-2xl border-2 border-[#2ab4c0] ring-4 ring-[#2ab4c0]/20 min-w-[280px]">
            <svg class="animate-spin w-12 h-12 text-[#2ab4c0]" fill="none" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col items-center">
                ...
                <span class="text-[11px] text-[#2ab4c0] font-bold mt-2 animate-pulse">
        ...
        <div class="bg-white rounded-xl border border-gray-200 mb-3 overflow-hidden">
            ...
            <div class="flex items-center bg-white border-b border-gray-200 px-2 gap-1 overflow-x-auto overflow-y-hidden no-scrollbar relative">
                ...
                @endforeach
		                ...
		                <div class="ms-auto flex-shrink-0 flex items-center gap-2">
