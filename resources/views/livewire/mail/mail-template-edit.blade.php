<div class="p-6 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mt-2">Edit Mail Template</h1>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form wire:submit="update" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" wire:model="name" class="mt-1 block w-full rounded-lg border-gray-200 bg-gray-50 focus:border-blue-500 focus:ring-blue-500 @error('name') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <textarea wire:model="content" rows="10" class="mt-1 block w-full rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 font-mono text-sm @error('content') border-red-500 @enderror"></textarea>
