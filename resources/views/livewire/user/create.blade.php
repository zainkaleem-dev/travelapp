            ...
            <div class="px-6 pt-2 border-b border-gray-200 bg-white">
                <div class="flex items-center gap-0 overflow-x-auto no-scrollbar text-[11px] font-semibold w-full">
                    <button type="button" @click="tab = 'personal'"
                        class="inline-flex items-center gap-1.5 px-4 py-2 flex-shrink-0 rounded-t-lg transition-colors whitespace-nowrap uppercase tracking-wider"
                    ...
                    <button type="button" @click="tab = 'family'"
                        ...
                        <svg class="w-3.5 h-3.5 flex-shrink-0 opacity-90" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M17 20h5V4H2v16h5m10 0v-4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v4m10 0H7" />
                        </svg>
                        Family Members
                    </button>
                    <button type="button" @click="tab = 'grades'"
                        class="inline-flex items-center gap-1.5 px-4 py-2 flex-shrink-0 rounded-t-lg transition-colors whitespace-nowrap uppercase tracking-wider"
                        :class="tab === 'grades' ? 'bg-[#2ab4c0] text-white font-semibold' : 'text-gray-600 hover:text-gray-900'">
        ...
        <div class="px-6 py-4">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                            <div class="flex items-center justify-between mb-6">
                                <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Identity &
                                    Organization
                                </h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                @if(count($companies) > 0)
                                    <div>
                                        <label class="field-label">Select Company <span
                                ...
                                <div>
                                    ...
                                    @if(empty($branches) && $company_id)
                                        <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">This company has no
                                            branches
                                            yet.</p>
                                    @elseif(!$company_id && auth()->user()->hasRole('Super Admin'))
                                        <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">Please select a company
                                            first.
                                        </p>
                                    @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="middle_name" class="input-field"
                                        placeholder="Quincy">
                        ...
                        <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                            <div class="flex items-center justify-between mb-6">
                                <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Account &
                                    Security</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    @error('email') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}
                                    </p> @enderror
                                </div>
                        ...
                        @if(!$isTmc)
                            ...
                            <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                                <div class="flex items-center justify-between mb-6">
                                    <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Additional
                                        Personal Info</h2>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        @error('phone') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}</p> @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('dob') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}</p> @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('gender') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}</p> @enderror
                                    </div>

                                    <div>
                                        <label class="field-label">Nationality</label>
                                        <input type="text" wire:model="nationality" class="input-field"
                                            placeholder="Nationality">
                                        @error('nationality') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}</p> @enderror
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                                <div class="flex items-center justify-between mb-6">
                                    <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Travel
                                        Documents</h2>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="text" wire:model="passport_number" class="input-field"
                                            placeholder="Passport number">
                                        @error('passport_number') <p
                                            class="mt-1 text-[11px] font-bold text-red-500 uppercase">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('expiry_date') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                        {{ $message }}</p> @enderror
                                    </div>

                                    <div>
                                        <label class="field-label">Issuing country</label>
                                        <input type="text" wire:model="issuing_country" class="input-field"
                                            placeholder="Issuing country">
                                        @error('issuing_country') <p
                                            class="mt-1 text-[11px] font-bold text-red-500 uppercase">{{ $message }}</p>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                                <div class="flex items-center justify-between mb-6">
                                    <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Preferences
                                    </h2>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" wire:model="preferred_airline" class="input-field"
                                            placeholder="Airline name">
                                        @error('preferred_airline') <p
                                            class="mt-1 text-[11px] font-bold text-red-500 uppercase">{{ $message }}</p>
                                        @enderror
                                    </div>
                                </div>
            ...
            @if(!$isTmc)
                <div x-show="tab === 'family'" x-cloak class="space-y-6">
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <table class="w-full text-sm">
                                <thead class="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        <th
                                            class="px-4 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider text-[11px]">
                                            Name</th>
                                        <th
                                            class="px-4 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider text-[11px]">
                                            Email</th>
                                        <th
                                            class="px-4 py-3 text-right font-semibold text-gray-700 uppercase tracking-wider text-[11px]">
                                            Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-100">
                                    @foreach ($familyMembers as $index => $fm)
                                        <tr>
                                            <td class="px-4 py-3 text-gray-900 font-medium">{{ $fm['first_name'] }}
                                                {{ $fm['last_name'] }}</td>
                                            <td class="px-4 py-3 text-gray-600">{{ $fm['email'] ?: '—' }}</td>
                                            <td class="px-4 py-3 text-right">
                                                <button type="button" wire:click="removeFamilyMember({{ $index }})"
                                                    class="text-red-600 hover:text-red-800 font-bold text-[11px] uppercase tracking-wider">Remove</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Add New Family Member
                            </h2>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                @error('f_first_name') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                {{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label class="field-label">Last Name *</label>
                                <input type="text" wire:model="f_last_name" class="input-field" placeholder="Last Name">
                                @error('f_last_name') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                {{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label class="field-label">Email</label>
                                <input type="email" wire:model="f_email" class="input-field" placeholder="Email">
                                @error('f_email') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                {{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label class="field-label">Phone</label>
                                <input type="tel" wire:model="f_phone" class="input-field" placeholder="Phone">
                                @error('f_phone') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">
                                {{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label class="field-label">Date of Birth</label>
                                <input type="date" wire:model="f_dob" class="input-field">
                                @error('f_dob') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">{{ $message }}
                                </p> @enderror
                            </div>
                            <div>
                                <label class="field-label">Gender</label>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label class="field-label">Passport number</label>
                                    <input type="text" wire:model="f_passport_number" class="input-field"
                                        placeholder="Passport number">
                                </div>
                                <div>
                                    <label class="field-label">Expiry date</label>
                                ...
                                <div>
                                    <label class="field-label">Issuing country</label>
                                    <input type="text" wire:model="f_issuing_country" class="input-field"
                                        placeholder="Issuing country">
                                </div>
                            </div>
                        </div>
                ...
                <div x-show="tab === 'grades'" x-cloak class="space-y-6">
                    <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                        ...
                        @if(count($availableGrades) > 0)
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                @foreach($availableGrades as $grade)
                                    <label
                                        class="relative flex items-center p-3 rounded-lg border cursor-pointer transition-all {{ in_array($grade->id, $selectedGrades) ? 'bg-[#f2feff] border-[#2ab4c0] shadow-sm' : 'bg-white border-gray-200 hover:border-gray-300' }}">
                                        <input type="checkbox" wire:model.live="selectedGrades" value="{{ $grade->id }}"
                                            class="sr-only">
                                        <div class="flex-1">
                                            <p
                                                class="text-[12px] font-bold {{ in_array($grade->id, $selectedGrades) ? 'text-[#2ab4c0]' : 'text-gray-700' }}">
                                                {{ $grade->name }}</p>
                                            @if($grade->department)
                                                <p class="text-[10px] text-gray-400 truncate uppercase font-bold">
                                                    {{ $grade->department->name }}</p>
                                            @endif
                                        </div>
                                        <div
                                            class="w-4 h-4 rounded-full border-2 flex items-center justify-center {{ in_array($grade->id, $selectedGrades) ? 'border-[#2ab4c0] bg-[#2ab4c0]' : 'border-gray-200' }}">
                        ...
                        @else
                            <div
                                class="flex flex-col items-center justify-center py-12 px-4 border-2 border-dashed border-gray-200 rounded-xl">
                                <svg class="w-12 h-12 text-gray-300 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M4 6h16M4 12h10M4 18h7" />
                                </svg>
                                <p class="text-sm text-gray-500 font-medium">No grades available for this company.</p>
                                <p class="text-[11px] text-gray-400 mt-1">Create grades in the Corporate Configuration section
                                    first.</p>
                            </div>
                        @endif
