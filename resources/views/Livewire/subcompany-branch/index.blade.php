        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div class="px-6 py-5 bg-gradient-to-r from-white to-[#f2feff] border-b border-gray-200">
                <div class="flex items-start justify-between gap-4">
                    <div class="min-w-0">
                        <h1 class="text-2xl font-black text-gray-900 tracking-tight truncate">My Branch</h1>
                        <p class="text-sm text-gray-600 mt-1 truncate">{{ $subCompany?->name ?? 'Sub Company' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="relative rounded-xl border border-gray-200 p-5">
                    ...
                    <div class="text-lg font-black text-gray-900">{{ $branch->name }}</div>
                    <div class="mt-1 text-sm text-gray-600">{{ $branch->code ?: '—' }}</div>
