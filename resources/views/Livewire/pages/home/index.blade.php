                ...
                <div class="container">
                    <div class="row my-5" data-aos="fade-up">
                        <div class="col-12">
                            ...
                            <p class="text-center theme-text-accent-two mb-0">Explore the best of travel with our
                            ...
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="float-start">
                                        ...
                                        <p class="font-small d-inline-flex mb-0 align-middle lh-1">IndiGo -
                                            Roundtrip<br>Economy </p>
                                    </div>
                                    <div class="float-end">
                        ...
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-3">Sun, 31/03 - Thu, 04/04</p>
                                    <div class="float-start">
                                        <img src="assets/images/icons/airasia.jpg" class="img-fluid theme-border-radius"
                                            alt="airasia" title="airline airasia">
                                        <p class="font-small d-inline-flex mb-0 align-middle lh-1">IndiGo -
                                            Roundtrip<br>Economy </p>
                                    </div>
                                    <div class="float-end">
                        ...
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-3">Sun, 31/03 - Thu, 04/04</p>
                                    <div class="float-start">
                                        <img src="assets/images/icons/thaiAir.jpg" class="img-fluid theme-border-radius"
                                            alt="Thai Air" title="Thai Air">
                                        <p class="font-small d-inline-flex mb-0 align-middle lh-1">IndiGo -
                                            Roundtrip<br>Economy </p>
                                    </div>
                                    <div class="float-end">
                        ...
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-3">Sun, 31/03 - Thu, 04/04</p>
                                    <div class="float-start">
                                        <img src="assets/images/icons/vistara.jpg" class="img-fluid theme-border-radius"
                                            alt="Vistara" title="airline Vistara">
                                        <p class="font-small d-inline-flex mb-0 align-middle lh-1">IndiGo -
                                            Roundtrip<br>Economy </p>
                                    </div>
                                    <div class="float-end">
                    ...
                    <div class="row" data-aos="fade-down">
                            ...
                            <div class="d-flex flex-column theme-box-shadow theme-border-radius">
                                <div class="picHeight overflow-hidden hoverShine theme-border-radius-top">
                                    <figure class="mb-0 img-effect">
                                        <img src="assets/images/featured-flights-deals/Deals01.png" class="img-fluid"
                                            alt="Deals One" title="Deals One">
                                    </figure>
                                    <div class="airline-tags position-absolute">
                                        <div class="flood-effect airline-icon">
                                            <img src="assets/images/icons/thaiAir.jpg" alt="airline"
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                            <div class="d-flex flex-column theme-box-shadow theme-border-radius">
                                <div class="picHeight overflow-hidden hoverShine theme-border-radius-top">
                                    <figure class="mb-0 img-effect">
                                        <img src="assets/images/featured-flights-deals/deals02.png" class="img-fluid"
                                            alt="Deals Two" title="Deals Two">
                                    </figure>
                                    <div class="airline-tags position-absolute">
                                        <div class="flood-effect airline-icon">
                                            <img src="assets/images/icons/vistara.jpg" alt="airline"
                                                class="img-fluid rounded-pill">
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                            <div class="d-flex flex-column theme-box-shadow theme-border-radius">
                                <div class="picHeight overflow-hidden hoverShine theme-border-radius-top">
                                    <figure class="mb-0 img-effect">
                                        <img src="assets/images/featured-flights-deals/deals03.png" class="img-fluid"
                                            alt="Deals Three" title="Deals Three">
                                    </figure>
                                    <div class="airline-tags position-absolute">
                                        <div class="flood-effect airline-icon">
                                            <img src="assets/images/icons/spicejet.jpg" alt="airline"
                                                class="img-fluid rounded-pill">
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                            <div class="d-flex flex-column theme-box-shadow theme-border-radius">
                                <div class="picHeight overflow-hidden hoverShine theme-border-radius-top">
                                    <figure class="mb-0 img-effect">
                                        <img src="assets/images/featured-flights-deals/deals04.png" class="img-fluid"
                                            alt="Deals Four" title="Deals Four">
                                    </figure>
                                    <div class="airline-tags position-absolute">
                                        <div class="flood-effect airline-icon">
                                            <img src="assets/images/icons/airasia.jpg" alt="airline"
                                                class="img-fluid rounded-pill">
                                ...
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination01.png" class="img-fluid"
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination02.png" class="img-fluid"
                                                    alt="flight-destination-two" title="flight-destination-two">
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xxl-6">
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination03.png" class="img-fluid"
                                                    alt="flight-destination-three" title="flight-destination-three">
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xxl-6">
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination04.png" class="img-fluid"
                                                    alt="flight-destination-four" title="flight-destination-four">
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xxl-6">
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination05.png" class="img-fluid"
                                                    alt="flight-destination-five" title="flight-destination-five">
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xxl-6">
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination06.png" class="img-fluid"
                                                    alt="flight-destination-six" title="flight-destination-six">
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xxl-6">
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination07.png" class="img-fluid"
                                                    alt="flight-destination-six" title="flight-destination-six">
                                            </figure>
                                        </div>
                                    </div>
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination08.png" class="img-fluid"
                                                    alt="flight-destination-six" title="flight-destination-six">
                                            </figure>
                                        </div>
                                    </div>
                            ...
                            <div class="theme-box-shadow theme-border-radius px-4 py-4 theme-bg-white">
                                <div class="row g-0">
                                    <div class="col-12 col-xxl-6 overflow-hidden theme-border-radius">
                                        <div class="overflow-hidden hoverShine">
                                            <figure class="mb-0 img-effect">
                                                <img src="assets/images/destination/destination09.png" class="img-fluid"
                                                    alt="flight-destination-six" title="flight-destination-six">
                                            </figure>
                                        </div>
                                    </div>
            ...
            <section class="py-5 theme-bg-white border-top" id="howWork">
                <div class="container">
                    <div class="row overflow-hidden py-5">
                        ...
                        <div class="col-12 col-lg-3 mb-4 mb-lg-0" data-aos="fade-left">
                            <div class="text-center theme-box-shadow theme-border-radius process-card">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="100" height="100.246" viewBox="0 0 100 100.246" class="process-icon">
                                    <defs>
                        ...
                        <div class="col-12 col-lg-3  mb-4 mb-lg-0" data-aos="fade-left">
                            <div class="text-center theme-box-shadow theme-border-radius process-card">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100.816"
                                    viewBox="0 0 100 100.816" class="process-icon">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-down" data-aos-delay="300">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                ...
                                <img src="assets/images/unique-ex/articles08.png" class="img-fluid"
                                    alt="Unique Experience One" title="Unique Experience One">
                        ...
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                ...
                                <img src="assets/images/unique-ex/articles11.png" class="img-fluid"
                                    alt="Unique Experience Two" title="Unique Experience Two">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-down" data-aos-delay="500">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Hamburg Speicherstadt,
                                        Germany</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles09.png" class="img-fluid"
                                    alt="Unique Experience Three" title="Unique Experience Three">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-down" data-aos-delay="600">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                ...
                                <img src="assets/images/unique-ex/articles04.png" class="img-fluid"
                                    alt="Unique Experience Four" title="Unique Experience Four">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-up" data-aos-delay="700">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                ...
                                <img src="assets/images/unique-ex/articles12.png" class="img-fluid"
                                    alt="Unique Experience Five" title="Unique Experience Five">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4" data-aos="fade-down" data-aos-delay="800">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect">
                                ...
                                <img src="assets/images/unique-ex/articles06.png" class="img-fluid"
                                    alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                    </div>
