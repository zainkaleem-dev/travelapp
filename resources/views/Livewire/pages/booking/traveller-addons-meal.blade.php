                        ...
                        <div class="col-12">
                            <ul class="d-flex flex-row justify-content-center">
                                <li class="p-3 me-3 active-addon">
                                    <a href="traveller-addons-meal.html"><img src="assets/images/icons/meal.png"
                                            class="img-fluid me-2" title="meal" alt="meal">Add
                                        Meals</a>
                                </li>
                                <li class="p-3 me-3">
                                    <a href="traveller-addons-baggage.html"><img src="assets/images/icons/baggage.png"
                                            class="img-fluid me-2" title="baggage" alt="baggage">Add
                                        Baggage</a>
                                </li>
                                <li class="p-3">
                                    <a href="traveller-addons-seat.html"><img src="assets/images/icons/seat.png"
                                ...
                                <li class="nav-item mb-3 mb-sm-0" role="presentation">
                                    <div class="p-2 border theme-border-radius d-flex align-items-center"
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/icons/6E.jpg" class="img-fluid" alt="Indigo"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer border-0 justify-content-center pb-5">
                            <button type="button" class="btn btn-effect btn-book"
                                onclick="window.location.href='{{ route('booking.payment') }}';">Yes
                                Sure</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="theme-box-shadow theme-border-radius bg-light mb-3 pb-0">
                                <div class="tab-content" id="pills-tabContent">
                                    <!-- flight departure baggage addon -->
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3 mb-lg-0 border-end">
                            <div class="row g-0 p-4 align-items-center">
                                <div class="col-12 col-md-7">
                                    <div class="fw-bold">Select Meal(s)</div>
                                    <div class="font-small font-medium">Gluten Free Non-Veg Meal</div>
                                </div>
                        ...
                        <div class="col-12 col-xl-6 mb-3 mb-lg-0 align-self-center">
                            <div class="row p-4">
                                ...
                                <div class="col-6 col-lg-6 align-self-center">
                                    <button type="button" class="btn btn-effect btn-book"
                                        onclick="window.location.href='{{ route('booking.payment') }}';">continue</button>
