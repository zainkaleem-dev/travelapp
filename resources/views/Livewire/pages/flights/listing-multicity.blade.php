            ...
            <div class="flight-search">
                <div class="container">
                    ...
                    <ul class="nav nav-tabs border-0" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link active" id="return-tab" data-bs-toggle="tab"
                                ...
                                <div class="col-12 col-lg-3">
                                    ...
                                    <div>
                                        <img src="assets/images/icons/thaiAir.jpg" class="img-fluid theme-border-radius"
                                            alt="thaiAir" title="airline thaiAir">
                                    </div>
                                    <div>
                                        <a href="#" class="font-small" data-bs-target="#flightDetailsModal"
                                            data-bs-toggle="modal">Flight Details</a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-4 mb-3 mb-lg-0 align-self-center">
                            <div class="row mb-3 mb-xl-0 align-items-center">
                                <div class="col-6 col-lg-7 align-self-center">
                                    ...
                                    <a href="#" class="font-small d-flex">Fare Details</a>
                                </div>
                                <div class="col-6 col-lg-5 text-end">
                                    <button type="submit" class="btn btn-effect btn-book"
                                        onclick="window.location.href='review-booking.html';">Book Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
