                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-3">
                            <div
                                ...
                                <div class="flex-1">
                                    <label
                                        class="block text-xs font-bold text-gray-900 uppercase tracking-tight mb-1">{{ $company_name }}
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <div class="flex flex-col items-center justify-center text-center">
                                        ...
                                        <p class="text-sm font-bold text-gray-900">Add more attachments</p>
                                                ...
                                                <div class="group relative flex items-center gap-4 p-4 rounded-xl border border-gray-100 bg-white hover:border-[#2ab4c0] transition-all shadow-sm hover:shadow-md">
                                                    ...
                                                    <div class="flex-1 min-w-0" x-data="{ editing: false, newName: '{{ $existingAttachmentNames[$uploadedAttachment->id] ?? $uploadedAttachment->original_name }}' }">
                                                        <div class="flex items-center gap-2" x-show="!editing">
                                                            <p class="text-sm font-bold text-gray-900 truncate tracking-tight">{{ $existingAttachmentNames[$uploadedAttachment->id] ?? $uploadedAttachment->original_name }}</p>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            @foreach($attachments as $index => $file)
                                                <div class="group relative flex items-center gap-4 p-4 rounded-xl border border-amber-100 bg-amber-50/30 hover:border-amber-400 transition-all shadow-sm">
                                                    ...
                                                    <div class="flex-1 min-w-0" x-data="{ editing: false, newName: '{{ $attachmentNames[$index] ?? $file->getClientOriginalName() }}' }">
                                                        ...
                                                        <div class="flex items-center gap-2" x-show="editing" @click.outside="editing = false">
                                                            <input type="text" x-model="newName" class="text-sm font-bold text-gray-900 border-b border-amber-500 bg-transparent focus:outline-none py-0 px-0" 
