<div class="px-1 py-1 w-full flex flex-col gap-3">
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
        <div class="px-6 py-3.5 bg-gradient-to-r from-white to-[#f2feff] flex items-center justify-between gap-4">
            <div>
                <h1 class="text-[21px] font-black text-gray-900 tracking-tight">Edit Subscription</h1>
                <p class="text-[11px] font-bold text-gray-500 uppercase mt-0.5">Updating plan for {{ $subscription->company->name }}</p>
            </div>
