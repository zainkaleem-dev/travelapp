    ...
    <div class="px-1 py-1 w-full">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md transition-all duration-200 flex items-center justify-between group">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Organizations</p>
                        <p class="text-xs text-gray-500 font-medium truncate">Total Registered</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-3xl font-black text-gray-900 tabular-nums">{{ $stats['organizations'] }}</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <canvas id="activityLineChart" height="260"></canvas>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <canvas id="entityBarChart" height="260"></canvas>
                </div>
            </div>
        </div>
