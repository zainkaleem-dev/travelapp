        ...
        <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        ...
                        <p class="mt-1 text-[11px] font-semibold text-gray-900">{{ $city->name }}</p>
                    </div>
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">Country</p>
                        <p class="mt-1 text-[11px] font-semibold text-gray-900">{{ $city->country->name }}</p>
                    </div>
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">Code</p>
                        <p class="mt-1 text-[11px] font-semibold text-gray-900">{{ $city->code }}</p>
                    </div>
                </div>
            </div>
        </div>
