    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm mb-4">
        <div class="px-6 py-3.5 bg-gradient-to-r from-white to-[#f2feff] border-b border-gray-200">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <h1 class="text-[21px] font-black text-gray-900 tracking-tight">Edit Division</h1>
                    <p class="text-[11px] text-gray-500 mt-1">Modify the existing division</p>
                </div>
                <a href="{{ route('divisions.index', ['companyId' => $companyId]) }}"
        ...
        <form wire:submit.prevent="update" class="p-6">
            <div class="space-y-8">
                ...
                <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-[11px] font-black tracking-widest text-gray-400 uppercase">Division Information</h2>
                    </div>

                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label class="field-label">Division Name <span class="text-red-500">*</span></label>
                            <input type="text" wire:model="name" class="input-field" placeholder="e.g. Sales & Marketing">
                            @error('name') <p class="mt-1 text-[11px] font-bold text-red-500 uppercase">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label class="field-label">Description</label>
                            <textarea wire:model="description" class="input-field min-h-[100px] py-3" placeholder="Brief description of this division..."></textarea>
            ...
            <div class="flex items-center justify-end gap-3 mt-10 pt-6 border-t border-gray-100">
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove>Update Division</span>
