<div class="w-full px-1 py-1">
    ...
    <div x-show="tab === 'grades'" x-cloak class="space-y-6">
        <div class="rounded-lg border border-gray-100 bg-gray-50/30 p-6">
            ...
            @else
                <div class="flex flex-col items-center justify-center py-12 px-4 border-2 border-dashed border-gray-200 rounded-xl">
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Create grades in the Corporate Configuration section first.</p>
                </div>
            @endif
