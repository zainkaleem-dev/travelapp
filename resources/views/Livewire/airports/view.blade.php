            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        ...
                        <p class="mt-1 text-[11px] font-semibold text-gray-900">{{ $airport->name }}</p>
                    </div>
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">City</p>
                        <p class="mt-1 text-[11px] font-semibold text-gray-900">{{ $airport->city->name }}, {{ $airport->city->country->code }}</p>
                    </div>
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">IATA Code</p>
                        <p class="mt-1 text-[11px] font-semibold text-gray-900 font-mono">{{ $airport->code }}</p>
                    </div>
                    <div class="rounded-lg border border-gray-200 bg-white px-4 py-3">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">ICAO Code</p>
                        <p class="mt-1 text-[11px] font-semibold text-gray-900 font-mono">{{ $airport->icao_code }}</p>
                    </div>
                </div>
            </div>
        </div>
