        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5">
                @forelse ($companies as $company)
                    <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow-md transition-shadow {{ $company->is_active ? '' : 'opacity-60 grayscale' }}">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="min-w-0">
                                        <div class="text-base font-black text-gray-900 truncate">{{ $company->name }}</div>
                                        <div class="mt-1 flex items-center gap-2">
                                            <div class="inline-flex items-center rounded-md bg-[#2ab4c0]/10 px-2 py-0.5 text-xs font-bold text-[#1f8f98]">
                                                {{ $company->type }}
                                            </div>
                                            <div class="inline-flex items-center rounded-md {{ $company->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-200 text-gray-700' }} px-2 py-0.5 text-[11px] font-black">
                        ...
                        <div class="mt-4 space-y-2 text-sm text-gray-700">
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <span class="font-semibold text-gray-900 truncate">{{ $company->email ?: '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between gap-3">
                                <span class="text-xs font-bold tracking-wide uppercase text-gray-500">Phone</span>
                                <span class="font-semibold text-gray-900 truncate">{{ $company->phone ?: '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between gap-3">
                                <span class="text-xs font-bold tracking-wide uppercase text-gray-500">Country</span>
                                <span class="font-semibold text-gray-900 uppercase">{{ $company->country ?: '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between gap-3">
                                <span class="text-xs font-bold tracking-wide uppercase text-gray-500">Subscription Plan</span>
                                <span class="font-semibold text-gray-900 truncate">{{ $company->subscription_plan ?: '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between gap-3">
                                <span class="text-xs font-bold tracking-wide uppercase text-gray-500">Company Limit</span>
                                <span class="font-semibold text-gray-900">{{ $company->company_limit ?: '—' }}</span>
                            </div>
                        </div>
                            ...
                            <div class="mt-4 flex items-center justify-between gap-3">
                                ...
                                <button type="button" wire:click="toggleActive({{ $company->id }})"
                                    class="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-black {{ $company->is_active ? 'bg-gray-900 text-white hover:bg-black' : 'bg-[#2ab4c0] text-white hover:bg-[#229aa4]' }}">
