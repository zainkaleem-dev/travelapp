                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="w-full sm:w-44">
                            <div class="relative" x-data="{ open: false, selected: @js($typeFilter ?? '') }" @keydown.escape.window="open = false" @click.outside="open = false">
                                ...
                                <div x-cloak x-show="open" x-transition.origin.top class="admin-menu-panel">
                                    <button type="button" class="admin-menu-item" :class="{ 'is-active': selected === '' }" @click="selected = ''; open = false; $wire.set('typeFilter', '')">All Types</button>
                                    <button type="button" class="admin-menu-item" :class="{ 'is-active': selected === 'Corporate' }" @click="selected = 'Corporate'; open = false; $wire.set('typeFilter', 'Corporate')">Corporate</button>
                                    <button type="button" class="admin-menu-item" :class="{ 'is-active': selected === 'TMC' }" @click="selected = 'TMC'; open = false; $wire.set('typeFilter', 'TMC')">TMC</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <tr class="border-b border-gray-200 transition-colors {{ $company->status === 'active' ? 'hover:bg-blue-50' : 'bg-gray-100' }}">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <a href="{{ route('admin.companies.features', $company->id) }}"
                                            class="group inline-flex items-center justify-center p-1 rounded-lg border border-gray-200 bg-transparent text-black text-xs font-semibold transition-colors hover:border-gray-400"
