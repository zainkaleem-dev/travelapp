        ...
        <div class="w-full max-w-sm">
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                <div class="px-6 py-6 space-y-4">
                    ...
                    @if($successMessage)
                        <div class="rounded-lg border border-green-200 bg-green-50 px-3 py-2 text-green-700"
                    ...
                    @if($errorMessage)
                        <div class="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-red-700"
                            style="font-size:11px">
                            {{ $errorMessage }}
                        </div>
                    @endif
                    ...
                    <form wire:submit="resetPassword" novalidate class="space-y-4">
                        ...
                        <div>
                            <label class="block text-gray-600 font-medium mb-1.5" style="font-size:11px">New
                                Password</label>
                        ...
                        <div>
                            <label class="block text-gray-600 font-medium mb-1.5" style="font-size:11px">Confirm
                                Password</label>
                            <input type="password" wire:model="password_confirmation" placeholder="Re-enter password"
                                class="input-field" />
                        </div>

                        <button type="submit"
                            class="login-btn w-full py-2.5 rounded-lg text-white font-bold flex items-center justify-center gap-2 mt-2"
