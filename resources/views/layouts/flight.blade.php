        ...
        @unless ($hideMainNavForSuperAdmin || $hideMainNavForCompanyAdmin) 
            <div class="max-w-7xl mx-auto px-3 sm:px-4"> 
                ...
                <a href="{{ route('roles.index') }}"
                    class="inline-flex items-center gap-1.5 px-3 py-2 sm:px-4 flex-shrink-0 {{ request()->routeIs('roles.index') ? 'bg-[#2ab4c0] text-white font-semibold' : 'text-gray-600 hover:text-gray-900' }} rounded-t transition-colors whitespace-nowrap">
                    <svg class="w-3.5 h-3.5 flex-shrink-0 opacity-90" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
