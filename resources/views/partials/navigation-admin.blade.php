<div class="flex flex-col md:flex-row w-full min-h-screen bg-slate-100">
    <div
        class="w-full md:w-72 md:min-h-screen md:sticky md:top-0 md:self-start flex-shrink-0 bg-white border-r border-gray-200 shadow-sm">
        <div class="p-4 md:py-6">
            ...
            <div
                class="mb-4 w-full rounded-lg shadow-sm transition-colors duration-300 overflow-hidden border border-gray-100">
                @if($company && isset($company->settings['logo_path']))
                    <div
                        class="bg-white px-4 py-6 flex justify-center border-b border-gray-100 bg-[radial-gradient(#f8fafc_1px,transparent_1px)] [background-size:16px_16px]">
                        <div
                            class="p-2 rounded-xl border-2 border-dashed border-gray-200 bg-white shadow-sm transition-transform hover:scale-[1.02] duration-300">
                            <div class="rounded-lg border border-gray-100 p-2 bg-white">
                                <img src="{{ asset('storage/' . $company->settings['logo_path']) }}"
                                    alt="{{ $company->name }} Logo" class="h-20 w-auto object-contain">
                            </div>
                        </div>
                    </div>
                @endif
                <div class="px-2.5 py-2.5 flex items-center justify-between gap-2"
                    style="background-color: {{ $sidebarBg }}; color: {{ $sidebarFg }};">
                    <div class="flex items-center gap-1 min-w-0">
                        <svg class="w-3.5 h-3.5 opacity-90 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center gap-1 flex-shrink-0">
                        <svg class="w-3.5 h-3.5 opacity-80 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div x-data="{ 
                    ...
                    <button type="button"
                        ...
                        <svg class="w-3.5 h-3.5 text-gray-500 transition-transform"
                            :class="{ 'rotate-180': openCorporate }" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div x-show="openCorporate" x-cloak class="ml-3 flex flex-col gap-1">
                        ...
                        <a href="{{ route('companies.show', ['id' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isCorpProfileActive ? '' : 'opacity-80' }}" fill="none"
                        ...
                        <a href="{{ route('users.index', ['companyId' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isCorpUsersActive ? '' : 'opacity-80' }}" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5">
                            <svg class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="{{ route('companies.travel-policy', ['id' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isTravelPolicyActive ? '' : 'opacity-80' }}" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="{{ route('grades.index', ['companyId' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isGradesActive ? '' : 'opacity-80' }}" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('divisions.index', ['companyId' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isDivisionsActive ? '' : 'opacity-80' }}" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('departments.index', ['companyId' => $activeCompanyId]) }}"
                            ...
                            <svg class="w-3 h-3 {{ $isDeptsActive ? '' : 'opacity-80' }}" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5">
                            <svg class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16v12H4zM8 10h8M8 14h5" />
                            </svg>
                            Custom Fields
                        </a>
                        ...
                        <button type="button"
                            ...
                            <svg class="w-3 h-3 text-gray-500 transition-transform"
                                :class="{ 'rotate-180': openCorpNotifications }" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="openCorpNotifications" x-cloak class="ml-3 flex flex-col gap-1">
                            ...
                            <a href="{{ route('admin.mail.index') }}"
                                ...
                                <svg class="w-3 h-3 {{ $isMailActive ? '' : 'opacity-80' }}" fill="none"
                                    stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3 8l9 6 9-6M4 6h16a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1z" />
                                </svg>
                                Mail Notifications
                            </a>
                            <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                    class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 8v4m0 4h.01M3 5h18v14H3z" />
                                </svg>Message of the Day</a>
                        </div>
                        ...
                        <button type="button"
                            ...
                            <svg class="w-3 h-3 text-gray-500 transition-transform"
                                :class="{ 'rotate-180': openCorpIntegrations }" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="openCorpIntegrations" x-cloak class="ml-3 flex flex-col gap-1">
                            <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                ...
                                </svg>HR Integration</a>
                            <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                    class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 15v2m-6 4h12a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2zm10-10V7a4 4 0 1 0-8 0v4h8z" />
                                </svg>SSO / Authentication</a>
                            <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                    class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M7 12h10M12 7l5 5-5 5" />
                                </svg>Approval Integration</a>
                        </div>
                    ...
                    <button type="button"
                        ...
                        <svg class="w-3.5 h-3.5 text-gray-500 transition-transform" :class="{ 'rotate-180': openTmc }"
                    ...
                    <div x-show="openTmc" x-cloak class="ml-3 flex flex-col gap-1">
                        ...
                        @php($isTmcUsersActive = $isTmcContext && request()->routeIs('users.*'))
                                    <a href="{{ route('users.index', ['companyId' => $activeCompanyId]) }}"
                                        ...
                                        <svg class="w-3 h-3 {{ $isTmcUsersActive ? '' : 'opacity-80' }}" fill="none"
                                            stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                                        </svg>
                                    ...
                                    <button type="button"
                                        ...
                                        <svg class="w-3 h-3 text-gray-500 transition-transform"
                                            :class="{ 'rotate-180': openTmcServices }" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7" />
                                        </svg>
                                    ...
                                    <div x-show="openTmcServices" x-cloak class="ml-3 flex flex-col gap-1">
                                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                                class="w-3 h-3 opacity-80" fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                        ...
                                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                                ...
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M3 13h18M7 13V9a2 2 0 1 1 4 0v4m0 0h6v3H3v-3h8z" />
                                            </svg>Car</a>
                                    </div>
                                    ...
                                    <button type="button"
                                        ...
                                        <svg class="w-3 h-3 text-gray-500 transition-transform"
                                            :class="{ 'rotate-180': openTmcIntegrations }" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7" />
                                        </svg>
                                    ...
                                    <div x-show="openTmcIntegrations" x-cloak class="ml-3 flex flex-col gap-1">
                                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                                ...
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 7h16M4 12h16M4 17h16" />
                                            </svg>Provider Accounts</a>
                                        <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                                class="w-3 h-3 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M4 5h16v14H4zM8 9h8M8 13h5" />
                                            </svg>Back Office System</a>
                                    </div>
                                    ...
                                    <a href="#" class="admin-menu-item inline-flex items-center gap-1.5"><svg
                                            ...
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M12 8c-2.2 0-4 .9-4 2s1.8 2 4 2 4 .9 4 2-1.8 2-4 2m0-10V6m0 12v-2" />
                                        </svg>Manage Service Fees &amp; Markup</a>
                                </div>
                                @endif
