...
{
    /**
     * Returns a list of all world countries with their names, ISO alpha-2 codes, and calling codes.
     */
    ...
    /**
     * Returns an array of dial codes for validation.
     */
    public static function getDialCodes(): array
    {
        return array_column(self::getAllCountries(), 'dial_code');
    }

    /**
     * Returns an array of country names for validation.
     */
    public static function getCountryNames(): array
    {
        return array_column(self::getAllCountries(), 'name');
    }
