...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], static function (Blueprint $table) {
            ...
            $table->string('name', 90);       // For MyISAM use string('name', 225); // (or 166 for InnoDB with Redundant/Compact row format)
            $table->string('guard_name', 90); // For MyISAM use string('guard_name', 25);
            $table->timestamps();
